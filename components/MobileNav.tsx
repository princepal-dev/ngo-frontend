...
export default async function navbar() {
  ...
  return (
    <nav className="flex w-60  justify-center bg-white   border-cyan-950 shadow-xl py-6">
      <div className=" ">
        <div className="flex flex-col items-center gap-4 justify-between">
          <Link href="/">
            <Image src={logo} height={50} width={50} alt="logo" />
          </Link>
          <ul className="flex flex-col gap-12 text-zinc-800 font-medium items-center transition-all duration-500 ">
            <li>

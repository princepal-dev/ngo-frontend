        ...
        <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="text-gray-600 list-disc mb-6 ">
              <li className="mb-1">
                <span className="font-semibold">Fundraising:</span> We organize
                various fundraising events and campaigns to gather the necessary
                resources to support our initiatives. Every contribution, big or
                small, helps us move closer to our goal.
              </li>
              <ul className="list-disc ml-6">
                <li>
                  Community Events: Hosting local events such as charity runs,
                  bake sales, and cultural programs to engage the community and
                  raise funds.
                </li>
                <li>
            ...
            <ul className="text-gray-600 list-disc mb-6">
              <li className="mb-1">
                <span className="font-semibold">Health Check-ups:</span> Regular
                health assessments are conducted to monitor and improve the
                well-being of the children. We collaborate with healthcare
                professionals to provide comprehensive check-ups.
              </li>
              <ul className="list-disc ml-6">
                <li>
                  Medical Camps: Organizing periodic health camps in Aanganwadis
                  with the help of volunteer doctors and nurses.
                </li>
                <li>
            ...
            <ul className="text-gray-600 list-disc mb-6">
              <li className="mb-1">
                <span className="font-semibold">Meal Planning:</span> We develop
                nutritious meal plans tailored to the specific needs of each
                child, ensuring they receive balanced and healthy diets.
              </li>
              <ul className="list-disc ml-6">
                <li>
                ...
                <li>
                  Food Sourcing: Partnering with local farmers and suppliers to
                  source fresh, high-quality ingredients for the meals.
                </li>
              </ul>
            </ul>
            <ul className="text-gray-600 list-disc mb-6">
              <li className="mb-1">
                <span className="font-semibold">Sustainability Measures:</span>{" "}
                We focus on creating long-term strategies to maintain and expand
                our impact, ensuring that our efforts continue to benefit future
                generations.
              </li>
              <ul className="list-disc ml-6">
                <li>
                  Training Programs: Providing training for Aanganwadi staff and
                  community volunteers on nutrition, health, and hygiene
                  practices.
                </li>
                <li>
                ...
                <li>
                  ...
                  evaluation systems to track the progress and impact of our
                  programs.
                </li>
              </ul>
            </ul>
      ...
      <section className="bg-emerald-600 text-white py-12 md:py-16">
        <div className="container mx-auto px-4 ">
          ...
          <p className="text-lg mb-6 text-center">
            ...
            create a better world for children and our planet. <br /> Your
          ...
          <div className="flex justify-center">
            <div>
              <ul className="text-gray-100 list-disc mb-6 ">
                <li className="mb-1">
                  <span className="font-semibold">Donate:</span> Your financial
                  contributions can make a significant impact. Every donation
                  helps us provide better nutrition and healthcare to the
                  children.
                </li>
                <ul className="list-disc ml-6">
                  <li>
                    One-Time Donations: Make a one-time donation to support our
                    immediate needs.
                  </li>
                  <li>
              ...
              <ul className="text-gray-100 list-disc mb-6">
                ...
                <ul className="list-disc ml-6">
                  ...
                  <li>
                    Professional Volunteers: Share your expertise in areas such
                    as healthcare, nutrition, education, and project management.
                  </li>
                  <li>
                    Community Outreach: Assist in spreading awareness about our
                    cause and engaging the local community.
                  </li>
                </ul>
              </ul>
              <ul className="text-gray-100 list-disc mb-6">
                <li className="mb-1">
                  ...
                  us raise awareness about our cause by sharing our mission with
                  your friends, family, and social networks.
                </li>
                <ul className="list-disc ml-6">
                  <li>
                    Social Media: Follow us on social media and share our posts
                  ...
                  <li>
                    ...
                    child nutrition and health at the local and national levels.
                  </li>
                </ul>
              </ul>
            </div>

                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
                        ...
                        <p className="mb-6 text-gray-600">
                            Join our team of dedicated volunteers and make a
                            real difference in the lives of children and our
                            environment. Fill out the form below to get started!
                        </p>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Upload a recent photo of
                                                yourself. Max file size: 5MB.
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Upload a copy of your identity
                                                card. Max file size: 5MB.
                                                Accepted formats: .jpg, .jpeg,
                                                .png, .webp, .pdf
                                            </FormDescription>
                                            <FormMessage />
            ...
            <section className="bg-emerald-600 text-white py-12 md:py-16">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-lg mb-6">
                        Can&apos;t volunteer right now? There are other ways you
